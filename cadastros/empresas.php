<?php 
    ...
    if(count($_POST) > 0){
        ...
        if(empty($cnpj)){
            ...
            $sql_cnpj = "SELECT * FROM empresas WHERE cnpj=?";
        ...
        if($error){
            ...
            $sql_code = "INSERT INTO empresas (nome, cidade, endereco, proprietario, cnpj) VALUES (?, ?, ?, ?, ?)";
...
<body>
    <header>
        ...
        <nav><a href="../consultas/consulta.php">Consulta de Dados</a> | <a href="clientes.php">Cadastrar novo cliente</a> | <a href="servicos.php">Cadastrar novo serviço</a></nav><hr><br>
    </header>
    <main>
        <section>
            <form action="<?=$_SERVER['PHP_SELF'];?>" method="post">
                ...
                <p>
                    <label>Proprietário </label><input type="text" name="proprietario" value="<?php if(isset($_POST['proprietario'])){ echo $_POST['proprietario']; }?>">
                </p>
                <p>
                    <label>CNPJ </label><input type="text" name="cnpj" value="<?php if(isset($_POST['cnpj'])){ echo $_POST['cnpj']; }?>"><span class="error"> *</span>
                </p>
                <p>
